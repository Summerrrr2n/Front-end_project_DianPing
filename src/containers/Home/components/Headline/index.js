                    ...
                    <Slider {...settings}>
                        {
                            dataSource.map((itme,index) => {
                                return (
                                    <a key={index} className='headline__sliderInner' href={itme.url}>
                                        <div className='headline__sliderTitle'>{itme.title}</div>
                                        <div className='headline__sliderImgWrapper'>
                                            <img className='headline__sliderImg' src={itme.pic} alt=''></img>
                                        </div>
                                    </a>
                                )
                            })
